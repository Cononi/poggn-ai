...
- TASKS.md, DECISIONS.md, RISKS.md, AGENT_REVIEWS.md, RESEARCH.md 전체를 자동 context로 주입하지 않습니다.
...
- 장부 파일은 사람이 검토하는 산출물로 저장하고, AI는 필요한 decision/risk/review 항목만 부분 조회합니다.
...
- agent 회의록은 장문 대화가 아니라 verdict, risk, recommendation, evidence 판정표로 제한합니다.
...
- 사용자 검토용 장부 파일 전체를 AI context나 subagent prompt에 붙이는 상태.
...
- 장부 파일은 생성하되 context 사용량은 summary/trace/files 중심으로 제한됩니다.
