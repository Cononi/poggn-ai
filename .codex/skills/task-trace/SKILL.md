...
- DECISIONS.md, RISKS.md, AGENT_REVIEWS.md, RESEARCH.md는 사용자 검토용 장부로 보고 원본 상태를 대체하지 않습니다.
...
- main decision은 DECISIONS.md에, unresolved risk와 follow-up 후보는 RISKS.md에 기록합니다.
- agent 판정표는 AGENT_REVIEWS.md에, 최신 기술 확인 근거는 필요할 때 RESEARCH.md에 기록합니다.
...
- 장부 파일은 길어져도 자동 context에 넣지 않고 필요한 항목만 summary/trace/files로 조회합니다.
...
- 장부에는 리스크가 있는데 TASK/lane/commit과 연결되지 않은 상태.
...
- decision, risk, agent review, research 항목이 관련 TASK/lane/commit을 참조합니다.
