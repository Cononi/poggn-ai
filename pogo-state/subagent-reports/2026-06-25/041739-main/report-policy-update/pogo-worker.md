...
- evidence:
  ...
  - pogo/pogo-subagent-auto SKILL 및 에이전트 toml의 `report_file` 설명을 `pogo-state/subagent-reports/<YYYY-MM-DD>/<HHMMSS>-<sanitized-branch>/<task-id>/<agent-name>.md`로 통일했습니다.
...
- report_file: pogo-state/subagent-reports/2026-06-25/041739-main/report-policy-update/pogo-worker.md
